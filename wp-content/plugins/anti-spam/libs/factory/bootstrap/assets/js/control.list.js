( function( $ ){
    ...
    $.fn.factoryBootstrap428_listControl = function (option) {
    ...
    $.fn.factoryBootstrap428_listControl.Constructor = list;

    $(function(){
        $(".factory-bootstrap-428 .factory-list").factoryBootstrap428_listControl();
    });
