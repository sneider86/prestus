( function( $ ){
    ...
    $.fn.factoryBootstrap428_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap428_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-428 .factory-gradient").factoryBootstrap428_gradientControl();
    });
