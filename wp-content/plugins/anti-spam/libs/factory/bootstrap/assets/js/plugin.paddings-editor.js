( function( $ ){
    ...
    $.fn.factoryBootstrap428_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap428_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-428 .factory-paddings-editor").factoryBootstrap428_paddingsEditor();
    });
