...
if( is_array($args) && !empty($args)) {
    ...
    if(!$this->plugin->is_premium())
    {
        ...
        <table class="table table-striped table-hover table-responsive" width="100%">
		    ...
		    <?php
		    if ( ! empty( $wordpress ) ) {
		        ?><tr><td colspan="5" class="wtitan-vulner-table-section"><?php echo __('Wordpress','titan-security'); ?></td></tr><?php
		    ...
		    if ( ! empty( $plugins ) ) {
			    ?><tr><td colspan="5" class="wtitan-vulner-table-section"><?php echo __('Plugins','titan-security'); ?></td></tr><?php
		    ...
		    if ( ! empty( $themes ) ) {
			    ?><tr><td colspan="5" class="wtitan-vulner-table-section"><?php echo __('Themes','titan-security'); ?></td></tr><?php
