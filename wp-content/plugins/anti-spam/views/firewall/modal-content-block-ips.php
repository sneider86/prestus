...
<div class="wtitan-ips-blocking-modal__form">
	<div id="wtitan-ips-blocking-modal__ip-address-tab-content" class="wtitan-ips-blocking-modal__tab-content wtitan-ips-blocking-modal__tab-content--active">
		<p>
	...
	<div id="wtitan-ips-blocking-modal__custom-pattern-tab-content" class="wtitan-ips-blocking-modal__tab-content">
		<p>
			...
			<input type="text" id="wtitan-ips-blocking-modal__form-range-ip-field" placeholder="e.g., 192.168.200.200 - 192.168.200.220 or 192.168.200.0/24">
		</p>
		<p>
			...
			<input id="wtitan-ips-blocking-modal__form-hostname-field" type="text" placeholder="e.g., *.amazonaws.com or *.linode.com">
		</p>
		<p>
			...
			<input id="wtitan-ips-blocking-modal__form-user-agent-field" type="text" placeholder="e.g., *badRobot*, *MSIE*, or *browserSuffix">
		</p>
		<p>
			...
			<input id="wtitan-ips-blocking-modal__form-referrer-field" type="text" placeholder="e.g., *badwebsite.example.com*">
		</p>
	</div>
	<p>
