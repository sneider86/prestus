...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap428.patternControl", {
        ...
        showColorPanel: function() {
            ...
            this.$colorResult.val( this.$colorContol.factoryBootstrap428_colorControl('getValue') );
            this.$colorResult.trigger('change');
            this.$element.trigger('change');
        },
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap428_patternControl", $.factoryBootstrap428.patternControl );
        $(".factory-bootstrap-428 .factory-pattern").factoryBootstrap428_patternControl({});
    });
