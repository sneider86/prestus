( function($) {
	...
	$.fn.factoryBootstrap428_dropdownControl = function(option) {
	...
	$.fn.factoryBootstrap428_dropdownControl.Constructor = DropdownControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-428 .factory-dropdown").factoryBootstrap428_dropdownControl();
	});
