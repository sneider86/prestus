( function($) {
	...
	$.fn.factoryBootstrap428_checkboxControl = function(option) {
	...
	$.fn.factoryBootstrap428_checkboxControl.Constructor = CheckboxControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-428 .factory-checkbox.factory-buttons-way").factoryBootstrap428_checkboxControl();
	});
