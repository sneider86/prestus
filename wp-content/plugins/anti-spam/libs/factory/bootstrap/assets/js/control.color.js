...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap428.colorControl", {
        ...
        _init: function( event ) {
            ...
            this.$picker.factoryBootstrap428_iris(irisOptions); 
            this.$picker.off('focus');

            $(document).on("click.color.factory", function(){
               self.$picker.factoryBootstrap428_iris("hide");  
            });

            this.$picker.add(this.$background).on("click.color.factory", function(e){
               e.stopPropagation();
               self.$picker.factoryBootstrap428_iris("show");  
            });  
        },
        ...
        hidePicker: function() {
            ...
            this.$picker.factoryBootstrap428_iris( 'hide' );
        }, 

        showPicker: function() {
            this.$element.addClass('factory-picker-active');
            this.$picker.factoryBootstrap428_iris( 'show' );
        },
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap428_colorControl", $.factoryBootstrap428.colorControl );
        $(".factory-bootstrap-428 .factory-color").factoryBootstrap428_colorControl({});
    });
