( function( $ ){
    ...
    $.fn.factoryBootstrap428_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap428_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-428 .factory-integer").factoryBootstrap428_integerControl();
    });
