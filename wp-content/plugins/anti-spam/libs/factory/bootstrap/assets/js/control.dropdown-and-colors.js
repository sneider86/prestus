(function($) {
	...
	$.fn.factoryBootstrap428_dropdownAndColors = function(option) {
		// call an method
	...
	$.fn.factoryBootstrap428_dropdownAndColors.Constructor = dropdownAndColors;

	$(function() {
		$(".factory-bootstrap-428 .factory-dropdown-and-colors").factoryBootstrap428_dropdownAndColors();
	});
