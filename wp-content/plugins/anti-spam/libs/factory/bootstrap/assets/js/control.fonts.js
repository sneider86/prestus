...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap428.fontControl", {
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap428_fontControl", $.factoryBootstrap428.fontControl );
        $(".factory-bootstrap-428 .factory-font").factoryBootstrap428_fontControl({});
    });
