...
class WHLP_HideLoginPage extends Wbcr_FactoryClearfy218_PageBase {
	...
	public function __construct($plugin)
	{
		...
		$this->page_menu_short_description = __('Hide login page', 'hide-login-page');
	...
	public function getPageTitle()
	{
		if( defined('WTITAN_PLUGIN_ACTIVE') ) {
			return __('Login', 'hide-login-page');
		}
	 ...
	 * @param Wbcr_Factory426_Plugin $plugin
	 * @return array
	 * @see libs\factory\pages\themplates\FactoryPages426_ImpressiveThemplate
	 */
	...
	protected function getNewLoginUrl()
	{
		...
		if( WbcrFactoryClearfy218_Helpers::isPermalink() ) {
			return WbcrFactoryClearfy218_Helpers::userTrailingslashit(home_url('/') . $login_path);
		} else {
